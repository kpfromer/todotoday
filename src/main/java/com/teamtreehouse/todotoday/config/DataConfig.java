...
@Configuration
//Using spring data, spring data will generate our DAO implementations (look at TaskDao)
...
public class DataConfig {
    ...
    /*
    * The reason that LocalContainerEntityManagerFactoryBean instead of a LocalSessionFacotryBean is here is because
    * in this app we are using a spring data JPA repositories
    *
