...
public class TaskController {
    ...
    public String taskList(Model model) {
        /*
        * I could add "Principal principal" to the parameters and get the username
        *
        * But we are going to use thymeleaf instead
...
//        User user = userService.findByUsername(principal.getName());//Bad, another query to database- might slow down
        task.setUser(user);
